    ...
    return (
        <div>
            ...
            custom:w-[90%] custom:ml-[5%] custom:mr-[5%] pt-20 custom:pt-40'>
                <h1 className=' custom:pb-0 pb-6  text-6xl text-left custom:text-9xl font-bebas'>Do what you <span
                    className='text-transparent bg-clip-text  
                                bg-gradient-to-r from-purple to-red'>love</span></h1>
                <h1 className='text-right text-6xl custom:text-9xl font-bebas'><span className='text-transparent bg-clip-text  
